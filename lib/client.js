	...
	factory: (require) => {
		...
		*/
		...
		function PlusIcon({ size = 16, className }) {
			return (0, react_jsx_runtime.jsx)("svg", {
				...
				children: (0, react_jsx_runtime.jsx)("path", { d: "M8 3.5v9M3.5 8h9" })
			});
		}
		...
		function EditIcon({ size = 16, className }) {
			return (0, react_jsx_runtime.jsxs)("svg", {
				...svgProps(size, className),
				children: [(0, react_jsx_runtime.jsx)("path", { d: "M4 12.2l.7-2.1 7.2-7.2 1.4 1.4-7.2 7.2z" }), (0, react_jsx_runtime.jsx)("path", { d: "M9.4 5.2l1.4 1.4" })]
			});
		}
		...
		function TrashIcon({ size = 16, className }) {
			return (0, react_jsx_runtime.jsxs)("svg", {
				...svgProps(size, className),
				children: [
					(0, react_jsx_runtime.jsx)("path", { d: "M3.5 5.5h9" }),
					(0, react_jsx_runtime.jsx)("path", { d: "M5.5 5.5V12a1.5 1.5 0 0 0 1.5 1.5h2A1.5 1.5 0 0 0 10.5 12V5.5" }),
					(0, react_jsx_runtime.jsx)("path", { d: "M6.5 5.5V4.2a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1v1.3" })
				]
			});
		}
		//#endregion
		//#region \0dsh-css:D:\github\dsh-agent-teams\src\client\TeamSettingsPage.module.css.mjs
		const css = ".Nc72OW_wrap{flex-direction:column;gap:14px;max-width:620px;padding:16px 18px;display:flex}.Nc72OW_pickerRow{align-items:center;gap:8px;display:flex}.Nc72OW_select{background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border:1px solid var(--dsw-alias-border-l1);border-radius:6px;flex:1;min-width:0;padding:6px 8px;font-size:13px}.Nc72OW_select:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.Nc72OW_form{flex-direction:column;gap:10px;display:flex}.Nc72OW_field{flex-direction:column;gap:4px;display:flex}.Nc72OW_label{color:var(--dsw-alias-label-secondary);font-size:12px}.Nc72OW_textarea{background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border:1px solid var(--dsw-alias-border-l1);resize:vertical;box-sizing:border-box;border-radius:6px;width:100%;min-height:64px;padding:6px 8px;font-family:inherit;font-size:13px}.Nc72OW_textarea:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.Nc72OW_nameInput{background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border:1px solid var(--dsw-alias-border-l1);border-radius:6px;padding:6px 8px;font-size:13px;font-weight:600}.Nc72OW_nameInput:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.Nc72OW_nameStatic{color:var(--dsw-alias-label-primary);padding:6px 2px;font-size:14px;font-weight:600}.Nc72OW_empty{color:var(--dsw-alias-label-secondary);font-size:13px}.Nc72OW_hint{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:1.5}.Nc72OW_actions{align-items:center;gap:8px;display:flex}.Nc72OW_danger{color:var(--dsw-alias-state-error-primary)}";
		...
		var TeamSettingsPage_module_css_default = {
			...
			"nameStatic": "Nc72OW_nameStatic",
			"pickerRow": "Nc72OW_pickerRow",
			"select": "Nc72OW_select",
		...
		*/
		...
		function TeamSettingsPage() {
			...
			const [nameEditable, setNameEditable] = (0, react.useState)(false);
			const [confirmDelete, setConfirmDelete] = (0, react.useState)(false);
			const [busy, setBusy] = (0, react.useState)(false);
			const load = async () => {
				setSnap(await host.call("agent-teams/profiles/get"));
			};
				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						(0, react_jsx_runtime.jsxs)("select", {
							className: TeamSettingsPage_module_css_default.select,
							value: selected,
							...
							children: [(0, react_jsx_runtime.jsx)("option", {
								value: "",
								children: "选择成员模板…"
							}), snap.profiles.map((p) => (0, react_jsx_runtime.jsx)("option", {
								value: p.name,
								children: p.name
							}, p.name))]
						}),
						(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
							variant: "ghost",
							size: "sm",
							icon: (0, react_jsx_runtime.jsx)(PlusIcon, {}),
							title: "添加成员模板",
							onClick: onAdd,
							disabled: busy,
							children: "添加"
						...
						(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
							variant: "ghost",
							size: "sm",
							icon: (0, react_jsx_runtime.jsx)(EditIcon, {}),
							title: "重命名成员模板",
							onClick: onRename,
						...
						(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
							variant: "ghost",
							size: "sm",
							icon: (0, react_jsx_runtime.jsx)(TrashIcon, {}),
							title: confirmDelete ? "再次点击确认删除" : "删除成员模板",
							onClick: onDelete,
							disabled: draft === null || busy,
							className: confirmDelete ? TeamSettingsPage_module_css_default.danger : void 0,
							children: confirmDelete ? "确认?" : "删除"
						})
					]
					...
					children: [
						(0, react_jsx_runtime.jsxs)("div", {
							className: TeamSettingsPage_module_css_default.field,
							children: [(0, react_jsx_runtime.jsx)("span", {
								className: TeamSettingsPage_module_css_default.label,
								children: "名称"
							}), nameEditable ? (0, react_jsx_runtime.jsx)("input", {
								...
								className: TeamSettingsPage_module_css_default.nameStatic,
								children: draft.name
							})]
						}),
						(0, react_jsx_runtime.jsxs)("div", {
						...
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsx)("span", {
								...
								children: [(0, react_jsx_runtime.jsx)("option", {
									value: "",
									children: "默认（队长的模型）"
								}), snap.models.map((m) => (0, react_jsx_runtime.jsx)("option", {
									value: m,
									children: m
								}, m))]
							})]
						...
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsx)("span", {
								...
								disabled: busy,
								children: snap.efforts.map((e) => (0, react_jsx_runtime.jsx)("option", {
									value: e,
									children: effortLabel(e)
								}, e))
							})]
						}),
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsx)("span", {
								...
								children: [(0, react_jsx_runtime.jsx)("option", {
									value: "",
									children: "继承（队长的预设）"
								}), snap.presets.map((p) => (0, react_jsx_runtime.jsx)("option", {
									value: p,
						...
						(0, react_jsx_runtime.jsxs)("div", {
							className: TeamSettingsPage_module_css_default.actions,
